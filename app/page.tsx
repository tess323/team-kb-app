  ...
  return (
    <main className="max-w-4xl mx-auto px-4 py-10">
      <div className="flex items-center justify-between mb-8">
        <h1 className="text-3xl font-semibold text-ink">Rebrand User Experience</h1>
        {messages.length > 0 && (
          <button
          ...
          {messages.map((m, i) => (
            <div key={i} className={`flex ${m.role === "user" ? "justify-end" : "justify-start"}`}>
              {m.role === "user" ? (
                ...
                <div className="max-w-[85%] bg-cream border border-parchment-dark rounded-md px-4 py-3 text-sm text-ink leading-relaxed prose prose-sm max-w-none relative group">
                  <button
